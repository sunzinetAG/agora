...
class UserTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    ...
    {
        $favoritePost = new \AgoraTeam\Agora\Domain\Model\Thread();
        $favoritePostsObjectStorageMock = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage',
    ...
    {
        $observedThread = new \AgoraTeam\Agora\Domain\Model\Thread();
        $observedThreadsObjectStorageMock = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage',
            array('attach'), array(), '', false);
    ...
    {
        $spamPost = new \AgoraTeam\Agora\Domain\Model\Post();
        $spamPostsObjectStorageMock = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage', array('attach'),
            array(), '', false);
    ...
    {
        $spamPost = new \AgoraTeam\Agora\Domain\Model\Post();
        $spamPostsObjectStorageMock = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage', array('detach'),
            array(), '', false);
    ...
    {
        $group = new \AgoraTeam\Agora\Domain\Model\Group();
        $groupsObjectStorageMock = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage', array('attach'),
            array(), '', false);
    ...
    {
        $group = new \AgoraTeam\Agora\Domain\Model\Group();
        $groupsObjectStorageMock = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage', array('detach'),
            array(), '', false);
