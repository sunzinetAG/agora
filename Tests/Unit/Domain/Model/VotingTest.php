...
class VotingTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    ...
    {
        $answer = new \AgoraTeam\Agora\Domain\Model\VotingAnswer();
        $answersObjectStorageMock = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage', array('attach'),
            array(), '', false);
    ...
    {
        $answer = new \AgoraTeam\Agora\Domain\Model\VotingAnswer();
        $answersObjectStorageMock = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage', array('detach'),
            array(), '', false);
