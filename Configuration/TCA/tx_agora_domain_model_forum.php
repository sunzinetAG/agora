...
$ll = 'LLL:EXT:agora/Resources/Private/Language/locallang_db.xlf:tx_agora_domain_model_forum.';
...
return [
    'ctrl' => array(
        ...
        'dynamicConfigFile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('agora') .
            'Configuration/TCA/Forum.php',
    ...
    'columns' => array(
        ...
        'groups_with_read_access' => array(
            'exclude' => 1,
            'label' => $ll . 'groups_with_read_access',
            'config' => array(
                'type' => 'select',
        ...
        'groups_with_write_access' => array(
            'exclude' => 1,
            'label' => $ll . 'groups_with_write_access',
            'config' => array(
                'type' => 'select',
                'foreign_table' => 'fe_groups',
        ...
        'groups_with_modification_access' => array(
            'exclude' => 1,
            'label' => $ll . 'groups_with_modification_access',
            'config' => array(
                'type' => 'select',
                'foreign_table' => 'fe_groups',
        ...
        'users_with_read_access' => array(
            'exclude' => 1,
            'label' => $ll . 'users_with_read_access',
            'config' => array(
                'type' => 'select',
        ...
        'users_with_write_access' => array(
            'exclude' => 1,
            'label' => $ll . 'users_with_write_access',
            'config' => array(
                'type' => 'select',
                'foreign_table' => 'fe_users',
        ...
        'users_with_modification_access' => array(
            'exclude' => 1,
            'label' => $ll . 'users_with_modification_access',
            'config' => array(
                'type' => 'select',
                'foreign_table' => 'fe_users',
