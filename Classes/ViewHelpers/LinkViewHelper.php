...
//        \TYPO3\CMS\Extbase\Utility\DebuggerUtility::var_dump($this->tag->render(),__FILE__ . " " . __LINE__);
//        die;
    ...
    protected function getLinkToPost(Post $post, $settings, array $configuration = [])
    {
        ...
        $paginationSite = $this->paginationService->getPagePosition($post, $settings);
        if ($paginationSite != 0) {
...
//        \TYPO3\CMS\Extbase\Utility\DebuggerUtility::var_dump($paginationSite, __FILE__ . " " . __LINE__);
//        \TYPO3\CMS\Extbase\Utility\DebuggerUtility::var_dump($configuration, __FILE__ . " " . __LINE__);
